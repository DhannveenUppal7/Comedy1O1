...
import { View, Text, StatusBar, SafeAreaView, TouchableOpacity, FlatList, ImageBackground, ScrollView } from 'react-native'
...
const Onboarding = ({ route }) => {
    ...
    const getStarted = async () => {
        try {
            ...
            route.params.setOnBoarding(true);
        } catch (e) {
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={handleSkipToEnd}>
                        <Text style={{
                            fontSize: 18,
                            color: COLORS.black,
                            opacity: currentPage == slides.length - 1 ? 0 : 1
                        }}>Skip</Text>
                    </TouchableOpacity>
                ...
                <View style={{
                    ...
                    {/* Show or Hide Next button & GetStarted button by screen */}
                    {
                        currentPage != slides.length - 1 ? (
                            ...
                            // Get Started Button
                            <TouchableOpacity onPress={getStarted} style={{
                                paddingHorizontal: SIZES.base * 2,
                                height: 60,
                                borderRadius: 30,
                                backgroundColor: COLORS.primary,
    ...
    const renderFlatlistItem = ({ item }) => {
        return (
            <View style={{
                ...
                <ScrollView contentContainerStyle={{ paddingHorizontal: SIZES.base * 4, marginVertical: SIZES.base * 4 }}>
